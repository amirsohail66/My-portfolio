...
const Contact = () => {
    const handleCallClick = (e) => {
        // For non-mobile devices, prevent direct dialing and alert the contact number.
        if (!/Mobi|Android/i.test(navigator.userAgent)) {
            e.preventDefault();
            alert("Call me at: +91 6203765058");
        }
    };
    ...
    return (
        <>
            <div className="flex flex-col-reverse gap-10 overflow-hidden md:mt-12 md:flex-row">
                ...
                >
                    ...
                    <div className="mt-10 flex flex-wrap gap-4">
                        <div>
                            <a
                                href="https://mail.google.com/mail/?view=cm&fs=1&to=sohail.bnh@gmail.com"
                                target="_blank"
                        ...
                        <div>
                            <a href="tel:+916203765058" onClick={handleCallClick}>
                        ...
                        <div>
                            <a
                                ...
                                rel="noopener noreferrer"
                            >
                                <Button variant="outlined" endIcon={<Instagram />} sx={buttonSx}>
                                    Instagram
                                </Button>
                            </a>
                        </div>
                        <div>
                            <a
                                href="https://api.whatsapp.com/send?phone=916203765058"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                        ...
                        <div>
                            <a
                                href="https://www.facebook.com/amirsohailxp/"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
            ...
            <div className="mt-10 flex flex-col items-start gap-4 px-4">
                <h1 className="text-xl font-semibold text-slate-50">Thanks for scrolling.</h1>
                <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://drive.google.com/file/d/1915I2eLWR4I14e2RuA5tKk-YAksG77J2/view?usp=sharing"
                >
